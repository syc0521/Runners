...
namespace Runner.Rendering
{
    public class UIGrabPass : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            {
                UIGrabPassFeature.Instance.SetActive(true);
            }
        ...
        private void Update()
        {
            ...
            {
                UIGrabPassFeature.Instance.settings.renderScale = blurredResolutionScale;
        ...
        private void CloseUIGrabPass()
        {
            if (m_IsClosed == false)
            {
                ...
                if (s_GrabPassObjectCount < 0)
                {
                    ...
                    UIGrabPassFeature.Instance.SetActive(false);
                }
            }
        }
