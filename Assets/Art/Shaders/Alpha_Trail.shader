...
Shader "Effect/Alpha_Trail"
{
	Properties
	{
		...
		[ASEBegin]_R_Color("R_Color ", Color) = (1,1,1,1)
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 ShadowCoords = float4( 0, 0, 0, 0 );
					...
					#endif
				#endif
				float mulTime172 = _TimeParameters.x * _R_Panner.z;
				float2 appendResult171 = (float2(_R_Panner.x , _R_Panner.y));
				float2 uv_main_tex = IN.ase_texcoord3.xy * _main_tex_ST.xy + _main_tex_ST.zw;
				float2 panner169 = ( ( mulTime172 + _R_Panner.w ) * appendResult171 + uv_main_tex);
				float mulTime188 = _TimeParameters.x * _NoisePanner.z;
				float2 appendResult186 = (float2(_NoisePanner.x , _NoisePanner.y));
				float2 appendResult222 = (float2(_GB_Tiling.z , _GB_Tiling.w));
				float2 texCoord184 = IN.ase_texcoord3.xy * appendResult222 + float2( 0,0 );
				float2 panner185 = ( ( mulTime188 + _NoisePanner.w ) * appendResult186 + texCoord184);
				float mulTime226 = _TimeParameters.x * _G_Panner.z;
				float2 appendResult227 = (float2(_G_Panner.x , _G_Panner.y));
				float2 appendResult221 = (float2(_GB_Tiling.x , _GB_Tiling.y));
				float2 texCoord223 = IN.ase_texcoord3.xy * appendResult221 + float2( 0,0 );
				float2 panner225 = ( ( mulTime226 + _G_Panner.w ) * appendResult227 + texCoord223);
				float2 appendResult232 = (float2(_A_TilingOffset.x , _A_TilingOffset.y));
				float2 appendResult233 = (float2(_A_TilingOffset.z , _A_TilingOffset.w));
				float2 texCoord230 = IN.ase_texcoord3.xy * appendResult232 + appendResult233;
				float temp_output_211_0 = ( tex2D( _main_tex, texCoord230 ).a * _RGBA_Scale.w );
				float4 appendResult157 = (float4(( ( IN.ase_color * _R_Color * _RGBA_Scale.x * tex2D( _main_tex, ( panner169 + ( tex2D( _main_tex, panner185 ).b * _RGBA_Scale.z ) ) ).r ) + ( tex2D( _main_tex, panner225 ).g * _G_Color * _RGBA_Scale.y ) ).rgb , temp_output_211_0));
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = appendResult157.xyz;
				float Alpha = temp_output_211_0;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 appendResult232 = (float2(_A_TilingOffset.x , _A_TilingOffset.y));
				float2 appendResult233 = (float2(_A_TilingOffset.z , _A_TilingOffset.w));
				float2 texCoord230 = IN.ase_texcoord2.xy * appendResult232 + appendResult233;
				float temp_output_211_0 = ( tex2D( _main_tex, texCoord230 ).a * _RGBA_Scale.w );
...
/*ASEBEGIN
Version=18912
7;379;1535;491;137.0674;101.8226;1.3;True;False
Node;AmplifyShaderEditor.Vector4Node;231;-776.9316,999.4427;Inherit;False;Property;_A_TilingOffset;A_TilingOffset;8;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.8,1,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;210;140.7678,787.6674;Inherit;True;Property;_TextureSample1;Texture Sample 1;2;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;46;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector4Node;219;-406.7198,717.7778;Inherit;False;Property;_RGBA_Scale;RGBA_Scale;7;0;Create;True;0;0;0;False;0;False;10,3,0.1,1;20,1.56,0.03,1;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.PannerNode;185;-750.8024,487.0169;Inherit;True;3;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.Vector4Node;187;-1743.927,547.6433;Float;False;Property;_NoisePanner;NoisePanner;6;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.1,0.05,1,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector4Node;170;-812.0162,-72.94581;Float;False;Property;_R_Panner;R_Panner;4;0;Create;True;0;0;0;False;0;False;0,0,0,0;-0.5,0.2,1,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;183;-537.4728,482.6778;Inherit;True;Property;_Noise;Noise;2;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;46;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.DynamicAppendNode;157;1155.173,-80.88304;Inherit;False;FLOAT4;4;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.SimpleTimeNode;226;-882.5811,265.1718;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector4Node;229;-1148.292,197.2351;Float;False;Property;_G_Panner;G_Panner;5;0;Create;True;0;0;0;False;0;False;0,0,0,0;-0.35,0.1,1,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;49;212.1858,-234.6275;Half;False;Property;_R_Color;R_Color ;0;0;Create;True;0;0;0;False;0;False;1,1,1,1;0,0,0,0.4745098;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;46;127.9286,-64.06422;Inherit;True;Property;_main_tex;main_tex;2;0;Create;True;0;0;0;False;0;False;-1;None;05e7758da7a075a43b0589d3aea91846;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;217;122.3247,125.4846;Inherit;True;Property;_TextureSample0;Texture Sample 0;2;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;46;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;215;206.2187,317.8849;Half;False;Property;_G_Color;G_Color ;1;0;Create;True;0;0;0;False;0;False;1,1,1,1;0.2181814,0,1,0.3490196;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector4Node;220;-1668.898,-14.11166;Inherit;False;Property;_GB_Tiling;GB_Tiling;3;0;Create;True;0;0;0;False;0;False;1,1,1,1;0.85,0.15,1,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;235;2;157;0
WireConnection;235;3;211;0
WireConnection;235;4;239;0
ASEEND*/
//CHKSM=9ECA3176A095345E325B96B264B1F4CC3A643F19