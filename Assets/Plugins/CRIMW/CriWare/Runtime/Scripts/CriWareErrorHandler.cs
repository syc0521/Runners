...
public class CriWareErrorHandler : CriMonoBehaviour{
	...
	/**
	 * <summary>Setting the number of the error message buffers</summary>
	 * <remarks>
	 * <para header='Description'>Sets the maximum number of errors that can be handled within one frame of the application. <br/>
	 * If more errors occur within one frame, their log output etc. will be skipped. <br/>
	 * The default value is 8. <br/>
	 * The valid range is from 0 to 32. <br/></para>
	 * </remarks>
	 */
