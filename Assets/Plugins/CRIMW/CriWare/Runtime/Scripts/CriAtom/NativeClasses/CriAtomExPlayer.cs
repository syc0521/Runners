...
public class CriAtomExPlayer : CriDisposable
{
	 ...
	 * It can get using the ::CriAtomExPlayer::GetStatus function.<br/>
	 * <br/>
	 ...
	 * and call the ::CriAtomExPlayer::Start function, the status changes to playback preparation state ( Prep ) to prepare playback.<br/>
	 ...
	 * -# Use the ::CriAtomExPlayer::SetCue function to set the data to be played in the AtomExPlayer.<br/>
	 ...
	 * it in the ::CriAtomExPlayer::SetFile function,
	 * ::CriAtomExPlayer::CriAtomExPlayer(int, int) function must be used instead of this function.<br/>
	 * <br/>
	 ...
	 * the playback pitch cannot be changed using the ::CriAtomExPlayer::SetPitch function.<br/></para>
	 * </remarks>
	 * <seealso cref='CriAtomExPlayer::CriAtomExPlayer()'/>
	 ...
	 * Basic specification is the same as the ::CriAtomExPlayer::CriAtomExPlayer() function.<br/></para>
	 * </remarks>
	 * <seealso cref='CriAtomExPlayer::CriAtomExPlayer()'/>
	 * <seealso cref='CriAtomExPlayer::CriAtomExPlayer(int, int)'/>
	 * <seealso cref='CriAtomExPlayer::CriAtomExPlayer(bool)'/>
	 ...
	 * using the ::CriAtomExPlayer::Start function, the specified Cue is played.<br/></para>
	 * <para header='Note'>When a Cue is set using the ::CriAtomExPlayer::SetCue function,
	 ...
	 * is automatically set based on the information in the ACB file.)<br/></para>
	 * </remarks>
	 * <example><code>
	 *      :
	 *  // プレーヤの作成
	 ...
	 * using the ::CriAtomExPlayer::Start function, the specified Cue is played.</para>
	 * <para header='Note'>When a Cue is set using the ::CriAtomExPlayer::SetCueIndex function,
	 * the parameters set with the following functions are ignored.<br/>
	 *  - ::CriAtomExPlayer::SetFormat
	 *  - ::CriAtomExPlayer::SetNumChannels
	 *  - ::CriAtomExPlayer::SetSamplingRate
	 *  .
	 * (Information such as sound format, number of channels, sampling rate, etc.
	 * is automatically set based on the information in the ACB file.)<br/>
	 * <br/>
	 * By using this function, it is possible to set sound to the player
	 * without specifying the Cue name or Cue ID.<br/>
	 * (Even if you don't know the Cue name or Cue ID,
	 * the contents in the ACB file can be played back,
	 * so it can be used for debugging purposes.)<br/></para>
	 * </remarks>
	 * <example><code>
	 *      :
	 *  // プレーヤの作成
	 ...
	 * Loading of the file starts after calling the ::CriAtomExPlayer::Start function.<br/></para>
	 * <para header='Note'>When setting the sound data using the ::CriAtomExPlayer::SetContentId function,
	 ...
	 * by calling the ::CriAtomExPlayer::Start function to start playback.<br/>
	 * Note that the file is not loaded when this function is called.<br/>
	 * Loading of the file starts after calling the ::CriAtomExPlayer::Start function.<br/></para>
	 ...
	 * using the ::CriAtomExPlayer::Start function, the specified data is played.<br/></para>
	 * <para header='Note'>When using this function, it is necessary to create an AtomExPlayer for single file playback.<br/>
	 * Specifically, ::CriAtomExPlayer::CriAtomExPlayer(int, int) must be used
	 * instead of ::CriAtomExPlayer::CriAtomExPlayer().<br/>
	 * <br/>
	 ...
	 * <remarks>
	 * <para header='Description'>Creates an entry pool for linked playback using the functions such as ::CriAtomExPlayer::EntryData .<br/></para>
	 ...
	 * to the AtomExPlayer in advance using the functions such as ::CriAtomExPlayer::SetCue .<br/>
	 ...
	 * Before calling this function, it is necessary to set the sound data to be played
	 * to the AtomExPlayer in advance using the functions such as ::CriAtomExPlayer::SetData .<br/>
	 * <br/>
	 ...
	 * pausing by the ::CriAtomExPlayer::Pause function are canceled.<br/>
	 ...
	 * (or the ::CriAtomExPlayback::Pause function) is resumed.<br/>
	 ...
	 * ::CriAtomExPlayer::Pause function and the those paused by the ::CriAtomExPlayer::Prepare function.<br/>
	 ...
	 * using the ::CriAtomExPlayer::Start function, the sound is played with the specified volume.<br/>
	 * It is also possible to update the volume of the sound already played by calling
	 * the ::CriAtomExPlayer::Update or ::CriAtomExPlayer::UpdateAll function after setting the volume.<br/>
	 * <br/>
	 ...
	 * using the ::CriAtomExPlayer::Start function, the sound is played with the specified pitch.<br/>
	 * It is possible to update the pitch of the sound already played by calling
	 * the ::CriAtomExPlayer::Update or ::CriAtomExPlayer::UpdateAll function after setting the pitch.<br/>
	 * <br/>
	 ...
	 * After specifying playback ratio with this function, start with ::CriAtomExPlayer::Start
	 * to play back at the specified ratio.
	 * If you want to change the playback ratio during the playback,
	 * please call ::CriAtomExPlayer::Update or ::CriAtomExPlayer::UpdateAll function.</para>
	...
	*/
	 ...
	 * <para header='Note'>By setting 0.0f in the ::CriAtomExPlayer::SetBusSendLevel function and an offset value in this function,<br/>
	 * you can set the value ignoring the Bus Send Level set on the data. (Overridden)</para>
	 * </remarks>
	 * <seealso cref='CriAtomExPlayer::SetBusSendLevel'/>
	 */
	...
	*/
	 ...
	 * <br/>
	 * This parameter is cleared using the ::CriAtomExPlayer::ResetParameters function.</para>
	 ...
	 * the ::CriAtomExPlayer::Start function, the detached AISAC has no effect.<br/>
	 ...
	 * <br/>
	 * The AISAC control value is handled in the same way as in the ::CriAtomExPlayer::SetAisacControl function.<br/></para>
	 * </remarks>
	 * <example><code>
	 *  ：
	 * // プレーヤの作成
	...
	*/
	 ...
	 * <para header='Note'>Use the ::CriAtomExPlayback::SetNextBlockIndex function to move Block after starting playback,
	 ...
	 * see the Description of the ::CriAtomExPlayer::SetVoicePriority function.)<br/></para>
	 ...
	 * After calling this function, if you start playback using the ::CriAtomExPlayer::Start function, the sound is played using the default playback parameters.<br/></para>
	 * <para header='Note'>Even if the ::CriAtomExPlayer::Update or ::CriAtomExPlayer::UpdateAll function is called after calling this function,
	 ...
	 * call the ::CriAtomExPlayer::SetVolume function explicitly.<br/>
	 * <br/>
	 ...
	 * use the ::CriAtomExPlayback::GetTime function.<br/>
	 * <br/>
