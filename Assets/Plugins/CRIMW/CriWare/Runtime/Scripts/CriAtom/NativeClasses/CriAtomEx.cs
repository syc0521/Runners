...
public static class CriAtomEx
{
	 ...
	 * <remarks>
	 * <para header='Description'>Represents the type of sound renderer that ::CriAtomExPlayer creates internally.</para>
	 * </remarks>
	 */
	 ...
	 * <remarks>
	 * <para header='Description'>A data type for specifying the behavior when ::CriAtomExPlayer allocates a Voice.</para>
	 * </remarks>
	 ...
	 * Used in the ::CriAtomExPlayer::SetBiquadFilterParameters .</para>
	 * </remarks>
	 ...
	 * Used as an argument to the ::CriAtomExPlayer::Resume and
	 * ::CriAtomExPlayback::Resume functions.</para>
	 * </remarks>
	 ...
	 * Used in the ::CriAtomExPlayer::SetPanType .<br/></para>
	 * </remarks>
	 ...
	 * Used in functions such as ::CriAtomExPlayer::GetParameterFloat32 .</para>
	 * </remarks>
	 ...
	 * set by the ::CriAtomEx::SetVirtualSpeakerAngle function.</para>
	 ...
	 * Passed to the ::CriAtomExAcb::GetUsableAisacControl function as an argument.<br/></para>
	 * </remarks>
	...
	*/
	 ...
	 * The interruption to the server processing is prevented after this function is called until the ::CriAtomEx::Unlock function is called.<br/>
